...
const I18N = {
  zh: {
    ...
    source_webui: 'WebUI',
    add_stream: '添加直播间',
    stream_name_ph: '名称 (如: 向日葵)',
    stream_url_ph: '直播间URL或房间号',
    stream_added: '已添加',
    stream_confirm_del: '确定删除直播间',
    stream_stop_warn: '正在进行的翻译会停止',
    uid: 'UID',
    danmaku_max: '弹幕上限',
    created_at: '添加时间',
    valid: '有效',
  ...
  ja: {
    ...
    source_webui: 'WebUI',
    add_stream: '配信を追加',
    stream_name_ph: '名前 (例: VTuber A)',
    stream_url_ph: '配信URLまたはルームID',
    stream_added: '追加しました',
    stream_confirm_del: '配信ルームを削除',
    stream_stop_warn: '翻訳中の配信は停止します',
    uid: 'UID',
    danmaku_max: '最大文字数',
    created_at: '作成日',
    valid: '有効',
